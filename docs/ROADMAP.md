...
- P0-13 获取播放信息，并保存 media source id 与 play session id。
- P0-14 生成 Media3 可播放 media item，包括 direct stream / transcode URL。
- P0-15 调度 started / progress / stopped 播放 check-in。
- P0-16 把播放暂停、seek、音轨、字幕和播放速度变化同步到协议层。

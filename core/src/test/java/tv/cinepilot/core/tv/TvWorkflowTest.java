...
public final class TvWorkflowTest {
    ...
    private static void loadsHomeRowsFromMediaBrowserClient() {
        ...
        assertEquals(7, rows.size(), "home row count");
        ...
        assertEquals("latest:movies", rows.get(5).id(), "movies latest row id");
        assertEquals("latest:series", rows.get(6).id(), "series latest row id");
        ...
        assertEquals("/Users/user-1/Views", transport.requests.get(5).path(), "loader fetches views for latest rows");
        assertTrue(transport.requests.get(6).url(authenticated.server().address()).contains("ParentId=movies"), "movies latest");
        assertTrue(transport.requests.get(7).url(authenticated.server().address()).contains("ParentId=series"), "series latest");
    }
    ...
    private static void controllerRunsServerLoginBrowseAndPlaybackUseCase() {
        ...
        assertEquals("/Users/user-1/Items/movie-1", transport.requests.get(9).path(), "controller item detail request");
        assertEquals("/Items/movie-1/PlaybackInfo", transport.requests.get(10).path(), "controller playback info request");
        assertTrue(transport.requests.get(10).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("StartTimeTicks=120000000"), "controller resume ticks");
    }
    ...
    private static void controllerStartsPlaybackFromBeginningWhenRequested() {
        ...
        String playbackInfoUrl = transport.requests.get(10).url(MediaServerAddress.parse("https://media.example.com/jellyfin"));
    ...
    private static void controllerForwardsDeviceProfileToPlaybackInfo() {
        ...
        ProtocolRequest playbackInfo = transport.requests.get(10);
    ...
    private static void controllerLogoutRevokesSavedSession() {
        ...
        assertEquals("/Sessions/Logout", transport.requests.get(9).path(), "controller sends logout request");
    }
    ...
    private static void controllerOpensFirstChildForFolderBrowse() {
        ...
        assertEquals("/Users/user-1/Items", transport.requests.get(9).path(), "folder browse uses items endpoint");
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("ParentId=movies"), "folder browse passes parent id");
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("Limit=1"), "folder browse limits to first child");
    }
    ...
    private static void controllerBrowsesFolderRowsAndReturnsToParent() {
        ...
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("ParentId=series"), "folder browse passes parent id");
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("Limit=50"), "folder browse requests a page");
    ...
    private static void controllerPaginatesFolderRows() {
        ...
        assertTrue(transport.requests.get(10).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("StartIndex=50"), "next page start index");
        ...
        assertTrue(transport.requests.get(11).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("StartIndex=0"), "previous page start index");
    }
    ...
    private static void controllerSearchesMediaRows() {
        ...
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("SearchTerm=arrival"), "search query passes term");
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("IncludeItemTypes=Movie"), "search query passes filter");
        assertTrue(transport.requests.get(9).url(MediaServerAddress.parse("https://media.example.com/jellyfin")).contains("Limit=50"), "search query limits page size");

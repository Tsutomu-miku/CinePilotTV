...
object MediaWallTokens {
    const val ScreenX = 44
    const val ScreenTop = 20
    ...
    const val EdgeChromeGap = 5
    const val EdgeChromeRadius = 15
    const val HairlineAlpha = 46
    const val CollectionTintAlpha = 62
    const val TitleScrimAlpha = 150
    const val ProgressTrackAlpha = 70
    const val ProgressFillAlpha = 218
